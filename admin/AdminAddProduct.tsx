  ...
  return (
    <div className="pt-24 pb-20 px-4 max-w-6xl mx-auto">
      ...
      <div className="bg-zinc-900 border border-zinc-800 p-10">
        <h2 className="text-3xl font-serif italic mb-8">Editorial Catalog Entry</h2>
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div className="space-y-8">
            <div className="space-y-2">
              ...
              <input 
                ...
                placeholder="Ex: Italian Silk Blazer"
                value={formData.name}
          ...
          <div className="space-y-8">
            ...
            <button 
              ...
              className="w-full py-6 bg-white text-black text-xs uppercase tracking-[0.4em] font-black hover:bg-amber-400 transition-all disabled:opacity-50 mt-12 shadow-xl"
            >
              {loading ? 'CURATING CATALOG...' : 'PUBLISH TO EDITORIAL'}
            </button>
          </div>
        </form>
      </div>
